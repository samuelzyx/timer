...
class ActivityControllerSpec extends Specification implements ControllerUnitTest<ActivityController>, DomainUnitTest<Activity> {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.activityService = Mock(ActivityService) {
            1 * save(_ as Activity) >> { Activity activity ->
                throw new ValidationException("Invalid instance", activity.errors)
            }
        }
    ...
    void "Test the show action with a valid id"() {
        ...
        model.activity instanceof Activity
    }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Activity())
